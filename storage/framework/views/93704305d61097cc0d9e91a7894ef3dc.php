    ...
    <ul class="nav flex-column gap-2">
        <li class="nav-item">
            <a href="<?php echo e(route('dashboard')); ?>"
               class="nav-link d-flex align-items-center px-3 py-2 rounded-3 fw-semibold
                      <?php echo e(request()->is('dashboard') ? 'active-link' : 'text-light'); ?>">
        ...
        <li class="nav-item">
            <a href="<?php echo e(route('pegawai.index')); ?>"
               class="nav-link d-flex align-items-center px-3 py-2 rounded-3 fw-semibold
                      <?php echo e(request()->is('pegawai*') ? 'active-link' : 'text-light'); ?>">
        ...
        <li class="nav-item">
            <a href="<?php echo e(route('barang.index')); ?>"
               class="nav-link d-flex align-items-center px-3 py-2 rounded-3 fw-semibold
                      <?php echo e(request()->is('barang*') ? 'active-link' : 'text-light'); ?>">
                <span class="icon-circle me-3"><i class="bi bi-box-seam"></i></span>
                Barang
            </a>
        </li>
        <li class="nav-item">
            <a href="<?php echo e(route('barang_masuk.index')); ?>"
               class="nav-link d-flex align-items-center px-3 py-2 rounded-3 fw-semibold
                      <?php echo e(request()->is('barang_masuk*') ? 'active-link' : 'text-light'); ?>">
                <span class="icon-circle me-3"><i class="bi bi-box-arrow-in-down"></i></span>
                Barang Masuk
            </a>
        </li>
        <li class="nav-item">
            <a href="<?php echo e(route('barang_keluar.index')); ?>"
               class="nav-link d-flex align-items-center px-3 py-2 rounded-3 fw-semibold
                      <?php echo e(request()->is('barang_keluar*') ? 'active-link' : 'text-light'); ?>">
        ...
        <li class="nav-item">
            <a href="<?php echo e(route('absensi.index')); ?>"
               class="nav-link d-flex align-items-center px-3 py-2 rounded-3 fw-semibold
                      <?php echo e(request()->is('absensi*') ? 'active-link' : 'text-light'); ?>">
...
<?php /**PATH C:\Users\X390\webadmin\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>